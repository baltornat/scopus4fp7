                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= Html::a('Add', ['authors-scopus-author/create', 'project_ppi' => $model->id, 'erc_field' => $model->erc_field, 'p_id'=> $model->ppiOrganization->p_id], ['class' => 'btn btn-primary']) ?></div>
                                <br><br>
                            </div>
                        </div>
                        <div class="col-auto">
